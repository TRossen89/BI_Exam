...
st.write("")
st.write("1) The first chart is a chart of the aggregated dataset (Social Expenditure, Taxation etc.) where the features of the 3 countries with the highest GDP accross 10 years are compared with the features of the 3 countries with the lowest GDP accross 10 years (2012-2022)")
st.write("")
...
st.write("")
st.write("3) The third chart is a chart of 3 different clusters made from the World Happiness dataset. It visualize the percentage of countries from the different continents in each cluster")
st.write("---")
st.write("")
...
st.write("")
st.write("3 clusters were created with a K-Means model from the happiness features in the World Happiness dataset. These were created to see if some clusters of countries were better at predicting GDP from their happiness values than other clusters. The happiness features of cluster 3 were great at predicting GDP through a Linear Regression machine learning model. The model's R-Squared value was 0.808. The happiness features of cluster 1 and 2 weren't that great. Their R-squared values was around 0.6.")
